...
sed -i.bak -E "s/(wire \[2:0\] topDesign_auto_topMod_io_out_0_port_nvmm_)/\/\/\1/g" $v
sed -i.bak -E "s/(wire \[7:0\] topDesign_auto_topMod_io_out_0_port_lat_)/\/\/\1/g" $v
sed -i.bak -E "s/(wire \[63:0\] topDesign_auto_topMod_io_out_0_port_cnt_)/\/\/\1/g" $v
...
sed -i.bak -E "s/(\.auto_topMod_io_out_0_port_nvmm_)/\/\/\1/g" $v
sed -i.bak -E "s/(\.auto_topMod_io_out_0_port_lat_)/\/\/\1/g" $v
sed -i.bak -E "s/(\.auto_topMod_io_out_0_port_cnt_)/\/\/\1/g" $v
...
sed -i.bak -E "s/(assign topDesign_auto_topMod_io_out_0_port_nvmm_)/\/\/\1/g" $v
sed -i.bak -E "s/(assign topDesign_auto_topMod_io_out_0_port_lat_)/\/\/\1/g" $v
...
sed -i.bak -E "s/(input  \[2:0\]  auto_topMod_io_out_0_port_nvmm_)/\/\/\1/g" $v
sed -i.bak -E "s/(input  \[7:0\]  auto_topMod_io_out_0_port_lat_)/\/\/\1/g" $v
sed -i.bak -E "s/(output \[63:0\] auto_topMod_io_out_0_port_cnt_)/\/\/\1/g" $v
...
sed -i.bak -E "s/(wire \[2:0\] topMod_auto_io_out_0_port_nvmm_)/\/\/\1/g" $v
sed -i.bak -E "s/(wire \[7:0\] topMod_auto_io_out_0_port_lat_)/\/\/\1/g" $v
sed -i.bak -E "s/(wire \[63:0\] topMod_auto_io_out_0_port_cnt_)/\/\/\1/g" $v
...
sed -i.bak -E "s/(\.auto_io_out_0_port_nvmm_)/\/\/\1/g" $v
sed -i.bak -E "s/(\.auto_io_out_0_port_lat_)/\/\/\1/g" $v
sed -i.bak -E "s/(\.auto_io_out_0_port_cnt_)/\/\/\1/g" $v
...
sed -i.bak -E "s/(assign auto_topMod_io_out_0_port_cnt_)/\/\/\1/g" $v
sed -i.bak -E "s/(assign topMod_auto_io_out_0_port_nvmm_)/\/\/\1/g" $v
sed -i.bak -E "s/(assign topMod_auto_io_out_0_port_lat_)/\/\/\1/g" $v
sed -i.bak -E "s/(assign topMod_auto_io_out_0_port_lat_)/\/\/\1/g" $v
...
sed -i.bak -E "s/(input  \[2:0\]  auto_io_out_0_port_nvmm_)/\/\/\1/g" $v
sed -i.bak -E "s/(input  \[7:0\]  auto_io_out_0_port_lat_)/\/\/\1/g" $v
sed -i.bak -E "s/(output \[63:0\] auto_io_out_0_port_cnt_)/\/\/\1/g" $v
...
sed -i.bak -E "s/(wire \[2:0\] mig_io_port_nvmm_)/\/\/\1/g" $v
...
sed -i.bak -E "s/(assign auto_io_out_0_port_cnt_)/\/\/\1/g" $v
